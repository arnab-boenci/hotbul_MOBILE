...
import com.boenci.hotbul.fragment.MoreFragment;
import com.boenci.hotbul.fragment.MoviesFragment;
import com.boenci.hotbul.fragment.SearchFragment;
...
public class Home extends AppCompatActivity implements NavigationBarView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //notificationDataJsonObj.addProperty("Type","Movie");
        ...
        try {
           // JSONObject configObject = ConfigManager.loadConfig(this);
            int onScreenEffect = 0; //configObject.getInt("onscreen_effect");
