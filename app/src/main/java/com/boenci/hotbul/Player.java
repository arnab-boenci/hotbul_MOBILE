...
public class Player extends AppCompatActivity {
    ...
    void Prepare_Source(String source, String url, String DrmUuid, String DrmLicenseUri) {
        ...
        if (source.equalsIgnoreCase("m3u8")) {
            ...
            new BoenciStream(context, bGljZW5zZV9jb2Rl, new BoenciStream.OnInitialize() {
                @Override
                public void onSuccess(BoenciStream boenciStream) {
                    boenciStream.find(source, url, false, new BoenciStream.OnTaskCompleted() {
                        @Override
