...
import com.boenci.hotbul.adepter.CastAdepter;
import com.boenci.hotbul.adepter.CommentListAdepter;
import com.boenci.hotbul.adepter.DownloadLinkListAdepter;
import com.boenci.hotbul.adepter.PlayMovieItemListAdepter;
import com.boenci.hotbul.adepter.ReletedMovieListAdepter;
import com.boenci.hotbul.list.CastList;
import com.boenci.hotbul.list.CommentList;
import com.boenci.hotbul.list.DownloadLinkList;
import com.boenci.hotbul.list.MovieList;
import com.boenci.hotbul.list.PlayMovieItemIist;
import com.boenci.hotbul.model.SubtitleModel;
import com.boenci.hotbul.utils.FullSrceen;
import com.boenci.hotbul.utils.HTML5WebView;
import com.boenci.hotbul.utils.HelperUtils;
import com.boenci.hotbul.utils.LoadingDialog;
import com.boenci.hotbul.utils.PlayerUtils;
...
public class ShortFilmDetails extends AppCompatActivity {
    Context context;
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_short_film_details);
        ...
        volumeUnmute = findViewById(R.id.volume_unmute);
        volumnSeekbar = findViewById(R.id.volumn_seekbar);
        brightnessRelayout = findViewById(R.id.brightnessRelayout);
        volumeRelayout = findViewById(R.id.vvvRelayout);
        ...
        if(!AppConfig.allowVPN) {
            ...
            helperUtils = new HelperUtils(ShortFilmDetails.this);
            vpnStatus = helperUtils.isVpnConnectionAvailable();
            if (vpnStatus) {
                helperUtils.showWarningDialog(ShortFilmDetails.this, "VPN!", "You are Not Allowed To Use VPN Here!", R.raw.network_activity_icon);
            }
        }
...
//                startActivity(intent1);
                ...
                initVideoPlayer(mediaUrl, ShortFilmDetails.this, trailertype);
        ...
        //Custom Controller
        volumeMute.setVisibility(GONE);
        volumeUnmute.setVisibility(VISIBLE);
        volumeMute.setOnClickListener(v -> {
            player.setVolume(currentVolumn);
            volumeMute.setVisibility(GONE);
            volumeUnmute.setVisibility(VISIBLE);
            Toast.makeText(ShortFilmDetails.this, "volume mute", Toast.LENGTH_SHORT).show();
        });
        volumeUnmute.setOnClickListener(v -> {
            player.setVolume(0f);
            volumeMute.setVisibility(VISIBLE);
            volumeUnmute.setVisibility(GONE);
            Toast.makeText(ShortFilmDetails.this, "volume unmute", Toast.LENGTH_SHORT).show();
            ...
            if(AppConfig.all_movies_type == 0) {
                if(type== 1) {
                    ...
                    if (playPremium) {
                        ...
                        HelperUtils helperUtils = new HelperUtils(ShortFilmDetails.this);
                        helperUtils.Buy_Premium_Dialog(ShortFilmDetails.this, "Buy Premium!", "Buy Premium Subscription To Watch Premium Content", R.raw.rocket_telescope);
                    }
                ...
                if(AppConfig.all_movies_type == 0) {
                    if(type== 1) {
                        ...
                        if (downloadPremium) {
                            ...
                            HelperUtils helperUtils = new HelperUtils(ShortFilmDetails.this);
                            helperUtils.Buy_Premium_Dialog(ShortFilmDetails.this, "Buy Premium!", "Buy Premium Subscription To Download Premium Content", R.raw.rocket_telescope);
                        }
        ...
        reportButtonLinearLayout.setOnClickListener(view -> {
            if(userData != null) {
                final Dialog dialog = new Dialog(ShortFilmDetails.this);
                ...
                snackbar.setAction("Login", v -> {
                    Intent lsIntent = new Intent(ShortFilmDetails.this, LoginSignup.class);
...
//        currentPlayPostion = player.getCurrentPosition();
//        Intent intent = new Intent(WebSeriesDetails.this, com.boenci.hotbul.Player.class);
...
//                break;
    ...
    private void initView() {
        ...
        mBrightness = ShortFilmDetails.this.getWindow().getAttributes().screenBrightness;
...
//            StringRequest sr = new StringRequest(Request.Method.POST, "https://cloud.team-boenci.com/Boenci/IMDB/index.php", response -> {
    ...
    private void showDownloadOption(int id) {
        ...
        StringRequest sr = new StringRequest(Request.Method.GET, AppConfig.url +"getMovieDownloadLinks/"+id, response -> {
            if(!response.equals("No Data Avaliable")) {
                ...
                final Dialog downloadDialog = new Dialog(ShortFilmDetails.this);
        ...
        if(adType == 1) {   //AdMob
            ...
            InterstitialAd.load(this, AppConfig.adMobInterstitial, adRequest, new InterstitialAdLoadCallback() {
                ...
                public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                    interstitialAd.show(ShortFilmDetails.this);
            ...
            IUnityAdsLoadListener loadListener = new IUnityAdsLoadListener() {
                ...
                public void onUnityAdsAdLoaded(String placementId) {
                    UnityAds.show(ShortFilmDetails.this, AppConfig.Unity_rewardedVideo_ID, new UnityAdsShowOptions(), new IUnityAdsShowListener() {
                        @Override
            ...
            BannerView bannerView = new BannerView(ShortFilmDetails.this, AppConfig.Unity_Banner_ID, new UnityBannerSize(320, 50));
            bannerView.load();
                        ...
                        if(!AppConfig.Custom_Banner_click_url.equals("")) {
                            switch (AppConfig.Custom_Interstitial_click_url_type) {
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    Intent intent = new Intent(ShortFilmDetails.this, WebView.class);
            ...
            IronSourceBannerLayout banner = IronSource.createBanner(ShortFilmDetails.this, ISBannerSize.BANNER);
                ...
                if (!response.equals("No Data Avaliable")) {
                  ...
                  //  trailerextention = jsonObject.get("trailerextention").getAsString();
                   ...
                   // status = jsonObject.get("status").getAsInt();
                    ...
                    if(AppConfig.safeMode) {
                        Glide.with(ShortFilmDetails.this)
    ...
    void setFavourite() {
        ...
        StringRequest sr = new StringRequest(Request.Method.GET, AppConfig.url +"favourite/SET/"+ tempUserID +"/Movie/"+contentId, response -> {
            if(response.equals("New favourite created successfully")) {
               isFavourite = true;
               favouriteIcon.setImageDrawable(ContextCompat.getDrawable(ShortFilmDetails.this, R.drawable.red_heart_favorite));
            }
    ...
    void removeFavourite() {
        ...
        StringRequest sr = new StringRequest(Request.Method.GET, AppConfig.url +"favourite/REMOVE/"+ tempUserID +"/Movie/"+contentId, response -> {
            if(response.equals("Favourite successfully Removed")) {
                isFavourite = false;
                favouriteIcon.setImageDrawable(ContextCompat.getDrawable(ShortFilmDetails.this, R.drawable.heart_favorite));
            }
    ...
    protected void onStart() {
        ...
        volumnSeekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                if (b) {
                    mAudioManager.setStreamVolume(player.getAudioSessionId(), i, 0);
                }
            }
        ...
        volumeRelayout.setOnTouchListener(new View.OnTouchListener() {
            private final GestureDetector gestureDetector = new GestureDetector(ShortFilmDetails.this, new GestureDetector.SimpleOnGestureListener() {
                @Override
                public boolean onDoubleTap(MotionEvent e) {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_MOVE) {
                    mChangeVolume = true;
                    mVolumeProgressView.setVisibility(VISIBLE);
        ...
        brightnessRelayout.setOnTouchListener(new View.OnTouchListener() {
            private final GestureDetector gestureDetector = new GestureDetector(ShortFilmDetails.this, new GestureDetector.SimpleOnGestureListener() {
                @Override
                public boolean onDoubleTap(MotionEvent e) {
                    player.seekTo(player.getCurrentPosition() - 5000);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_MOVE) {
                    ...
                    mLightPeogressView.setVisibility(VISIBLE);
                } else if (event.getAction() == MotionEvent.ACTION_UP) {
                    mLightPeogressView.setVisibility(View.GONE);
                    mVolumeProgressView.setVisibility(View.GONE);
                }
        ...
        simpleExoPlayerView.setControllerVisibilityListener((StyledPlayerView.ControllerVisibilityListener) visibility -> {
            if (visibility == 0) {
                volumeRelayout.setVisibility(GONE);
                brightnessRelayout.setVisibility(GONE);
                if (!listSub.isEmpty()) {
                    //Empty
                }
                if (contollerLock) {
                ...
                volumeRelayout.setVisibility(VISIBLE);
                brightnessRelayout.setVisibility(VISIBLE);
                movieDetailsBack.setVisibility(GONE);
