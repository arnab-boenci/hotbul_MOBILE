...
import static com.boenci.hotbul.utils.Constants.AUTOPLAY;
import static com.boenci.hotbul.utils.Constants.EXTENTIONS;
import static com.boenci.hotbul.utils.Constants.SOFTWARE_EXTENTIONS;
...
import com.boenci.hotbul.adepter.LiquidPageradepter;
import com.boenci.hotbul.list.GenreList;
import com.boenci.hotbul.utils.AppOpenAdManagerActivity;
import com.boenci.hotbul.utils.HelperUtils;
import com.boenci.hotbul.utils.TinyDB;
...
//                    if (task.isSuccessful()) {
                        ...
                        AppConfig.rawUrl = "http://192.168.31.150/boenci/";
                        AppConfig.url = "http://192.168.31.150/boenci/android/";
                        AppConfig.apiKey = "ADu4MiTh16BztQyX";
                        AppConfig.allowVPN = true; //mFirebaseRemoteConfig.getBoolean("ALLOW_VPN");
                        AppConfig.FLAG_SECURE = false;
                        AppConfig.allowRoot = true;
                        AppConfig.verifyInstaller = false;
                        AppConfig.validateSignature = false;
                        AppConfig.releaseSignature = "";
          ...
          //  String token = jsonObjectJWT.get("token").getAsString();
            try {
               ...
               // JsonObject jsonObject = new Gson().fromJson(config, JsonObject.class);
                  apiKey = "ADu4MiTh16BztQyX"; //jsonObject.get("api_key").getAsString();
                  loginMandatory = 0 ; //jsonObject.get("login_mandatory").getAsInt();
                  maintenance = 0; //jsonObject.get("maintenance").getAsInt();
...
//                AppConfig.adType = jsonObject.get("ad_type").getAsInt();
            //    saveConfig(config);
             ...
             //   OneSignal.setAppId(jsonObject.get("onesignal_appid").getAsString());
                ...
                int onScreenEffect = 1; //jsonObject.get("onscreen_effect").getAsInt();
