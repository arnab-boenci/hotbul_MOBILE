...
import com.boenci.hotbul.adepter.EpisodeListAdepter;
import com.boenci.hotbul.adepter.ReletedWebSeriesListAdepter;
...
public class HouseofHorrorDetails extends AppCompatActivity implements EpisodeListAdepter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!AppConfig.allowVPN) {
            ...
            helperUtils = new HelperUtils(HouseofHorrorDetails.this);
        ...
        trailerLayout.setOnClickListener(view -> {
            if(!trailerUrl.equals("")) {
                Intent intent1 = new Intent(HouseofHorrorDetails.this, TrailerPlayer.class);
        ...
        reportButtonLinearLayout.setOnClickListener(view -> {
            if(userData != null) {
                final Dialog dialog = new Dialog(HouseofHorrorDetails.this);
                ...
                snackbar.setAction("Login", v -> {
                    Intent lsIntent = new Intent(HouseofHorrorDetails.this, LoginSignup.class);
            ...
            if(resultCode == RESULT_OK) {
                ...
                if(myData.getType() == 0) {
                    ...
                    if(playPremium) {
                        ...
                        HelperUtils helperUtils = new HelperUtils((HouseofHorrorDetails) context);
                        helperUtils.Buy_Premium_Dialog((HouseofHorrorDetails) context, "Buy Premium!", "Buy Premium Subscription To Watch Premium Content", R.raw.rocket_telescope);
                    }
                }
            }
        }
        ...
        if(adType == 1) {   //AdMob
            ...
            InterstitialAd.load(this, AppConfig.adMobInterstitial, adRequest, new InterstitialAdLoadCallback() {
                ...
                public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                    interstitialAd.show(HouseofHorrorDetails.this);
            ...
            IUnityAdsLoadListener loadListener = new IUnityAdsLoadListener() {
                ...
                public void onUnityAdsAdLoaded(String placementId) {
                    UnityAds.show(HouseofHorrorDetails.this, AppConfig.Unity_rewardedVideo_ID, new UnityAdsShowOptions(), new IUnityAdsShowListener() {
                        @Override
            ...
            BannerView bannerView = new BannerView(HouseofHorrorDetails.this, AppConfig.Unity_Banner_ID, new UnityBannerSize(320, 50));
            bannerView.load();
                        ...
                        if(!AppConfig.Custom_Banner_click_url.equals("")) {
                            switch (AppConfig.Custom_Interstitial_click_url_type) {
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    Intent intent = new Intent(HouseofHorrorDetails.this, WebView.class);
            ...
            IronSourceBannerLayout banner = IronSource.createBanner(HouseofHorrorDetails.this, ISBannerSize.BANNER);
    ...
    void loadWebSeriesDetails(int id) {
        ...
        StringRequest sr = new StringRequest(Request.Method.GET, AppConfig.url +"getWebSeriesDetails/"+id, response -> {
            ...
            if(AppConfig.safeMode) {
                Glide.with(HouseofHorrorDetails.this)
            ...
            if(trailerUrl.equals("")) {
                trailerIcon.setImageDrawable(ContextCompat.getDrawable(HouseofHorrorDetails.this, R.drawable.trailer_blocked_icon));
            } else {
                trailerIcon.setImageDrawable(ContextCompat.getDrawable(HouseofHorrorDetails.this, R.drawable.trailer_icon));
            }
    ...
    void setFavourite() {
        ...
        StringRequest sr = new StringRequest(Request.Method.GET, AppConfig.url +"favourite/SET/"+tempUserID+"/WebSeries/"+contentId, response -> {
            if(response.equals("New favourite created successfully")) {
                isFavourite = true;
                favouriteIcon.setImageDrawable(ContextCompat.getDrawable(HouseofHorrorDetails.this, R.drawable.red_heart_favorite));
            }
    ...
    void removeFavourite() {
        ...
        StringRequest sr = new StringRequest(Request.Method.GET, AppConfig.url +"favourite/REMOVE/"+tempUserID+"/WebSeries/"+contentId, response -> {
            if(response.equals("Favourite successfully Removed")) {
                isFavourite = false;
                favouriteIcon.setImageDrawable(ContextCompat.getDrawable(HouseofHorrorDetails.this, R.drawable.heart_favorite));
            }
