...
public class PopularSearchListAdepter extends RecyclerView.Adapter<PopularSearchListAdepter.MyViewHolder> {
    private Context mContext;
    private List<SearchList> mData;

    Context context;

    public PopularSearchListAdepter(Context mContext, List<SearchList> mData) {
    ...
    @NonNull
    @Override
    public PopularSearchListAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        context = parent.getContext();
        View view;
        LayoutInflater mInflater = LayoutInflater.from(mContext);
        view = mInflater.inflate(R.layout.search_item,parent,false);
        return new PopularSearchListAdepter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PopularSearchListAdepter.MyViewHolder holder, int position) {
        ...
        holder.Movie_Item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if(mData.get(position).getContent_Type().equalsIgnoreCase("Web Series")) {
